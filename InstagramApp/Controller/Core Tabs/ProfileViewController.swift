...
//MARK: - UICollectionViewDataSource_Delegate_FlowLayout
...
extension ProfileViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        if indexPath.section == 1 {
            // Tabs header
            let tabsControlHeader = collectionView.dequeueReusableSupplementaryView(
                ofKind: kind,
                withReuseIdentifier: ProfileTabsCollectionReusableView.identifier,
...
extension ProfileViewController: ProfileInfoHeaderCollectionReusableViewDelegate {
    ...
    func profileHeaderDidTapFollowersButton(_ header: ProfileInfoHeaderCollectionReusableView) {
        let mockData = TestModels.createUserRelationship(type: .followers)
    ...
    func profileHeaderDidTapFollowingButton(_ header: ProfileInfoHeaderCollectionReusableView) {
        let mockData = TestModels.createUserRelationship(type: .following)
